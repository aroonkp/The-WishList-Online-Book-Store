...
<body>
							...
							<div class="row">
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single.html">The Time Machine -H.G. Wells</a>
											</h4>
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single.html">The Forever War - Joe Haldeman</a>
											</h4>
											<div class="info-product-price my-2">
							...
							<div class="row">
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single.html">Murder is Easy - Agatha Christie</a>
											</h4>
											<div class="info-product-price my-2">
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single.html">Lethal White - </br> J.K. Rowling</a>
											</h4>
											<div class="info-product-price my-2">
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single.html">Dark Sacred Night - Michael Connelly</a>
											</h4>
											<div class="info-product-price my-2">
							...
							<div class="row">
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single.html">Half Girlfriend - Chetan Bhagat</a>
											</h4>
											<div class="info-product-price my-2">
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single.html">Pride and Prejudice - Jane Austen</a>
											</h4>
											<div class="info-product-price my-2">
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single.html">I too had a love story - Ravinder Singh</a>
											</h4>
											<div class="info-product-price my-2">
				...
				<div class="row footer-info w3-agileits-info">
					...
					<div class="col-md-3 col-sm-6 footer-grids mt-md-0 mt-4">
						...
						<ul>
							...
							<li class="mb-3">
								<i class="fas fa-mobile"></i> 983 xxx xxxx </li>
							<li class="mb-3">
								<i class="fas fa-phone"></i> 0612 xx xxxx </li>
							<li class="mb-3">
	...
	<div class="copy-right py-3">
		<div class="container">
			<p class="text-center text-white">© The WishList. All rights reserved | Design by
				<a href="http://w3layouts.com"> The WishList</a>
			</p>
		</div>
	</div>
	<!-- //copyright -->
