...
<head>
	<title>The WishList | Checkout</title>
	<!-- Meta tag Keywords -->
				...
				<div class="address_form_agile mt-sm-5 mt-4">
					...
					<form action="payment.php" method="post" class="creditly-card-form agileinfo_form">
						<div class="creditly-wrapper wthree, w3_agileits_wrapper">
							<div class="information-wrapper">
								<div class="first-row">
									...
									<div class="controls form-group">
									  ...
									  <input type="radio" name="gender" value="m" checked><strong>Male</strong>
  									  <input type="radio" name="gender" value="f"><strong>Female</strong>
  									  <input type=radio name="gender" value="o"><strong>Other</strong><br><br>
									...
									<div class="w3_agileits_card_number_grids">
										<div class="w3_agileits_card_number_grid_left form-group">
											<div class="controls">
												<input type="tel" class="form-control" placeholder="Mobile Number" name="number"  required="">
											</div>
										</div>
									...
									<div class="controls form-group w3_agileits_card_number_grid_left">
							...
							<?php else: ?>
							<input type="submit" value="Proceed to payment" class="btn btn-success btn-lg"></input>
				...
				<div class="row footer-info w3-agileits-info">
					...
					<div class="col-md-3 col-sm-6 footer-grids mt-md-0 mt-4">
						...
						<ul>
							...
							<li class="mb-3">
								<i class="fas fa-phone"></i> +0612 xxxx xxxx </li>
							<li class="mb-3">
